def create_vegetable_info():
    ...
    while True:
        ...
        color_of_fruit = input("Колір плода: ")
        try:
            average_weight = int(input("Середня вага одного плода: "))
        except ValueError:
            print("Невірний формат ваги. Повторіть введення.")
            continue
        unit_of_weight = input("Одиниці ваги плода (наприклад, грам, кілограм): ")
        ...
        vegetable = {
            ...
            "Відомості про плоди": {
                "Колір плода": color_of_fruit,
                "Середня вага одного плода": average_weight,
                "Одиниці ваги плода": unit_of_weight
            }
        }
